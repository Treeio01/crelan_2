...
return [
    ...
    'terms_section3_text' => 'Deelname aan de actie verloopt via een veilige identificatie: via de itsme-app, of via de gebruikersidentificatie van de bank. Na succesvolle identificatie ontvangt de deelnemer een bevestigingsmail van Crelan met een activatielink. Om geldig deel te nemen aan de actie, moet deze activatielink worden bevestigd. Deze e-mail is vergelijkbaar met de bevestiging die u ontvangt bij het activeren van de app op een nieuw toestel.',
    ...
    'terms_section5_text' => 'Deelnemers aan de actie kunnen genieten van de volgende voordelen: cashback van 3% op geselecteerde aankopen tijdens de actieperiode, een gegarandeerde geldbonus van €75 gestort op de rekening, 12 maanden gratis rekeningbeheer, en deelname aan een promotionele trekking met een kans om €20.000 te winnen. Alle voordelen zijn persoonlijk, niet overdraagbaar en slechts één keer per klant beschikbaar.',
