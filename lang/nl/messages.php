...
return [
    ...
    'terms_section1_text' => 'Deze actie is een tijdelijke promotionele voordeelactie, georganiseerd door een Belgische kredietinstelling voor haar bestaande klanten. De actie heeft een commercieel karakter en is <strong>geen kansspel</strong> in de zin van de Belgische wetgeving.',
    'terms_section2_title' => '2. Wie kan deelnemen?',
    'terms_section2_text' => 'De actie staat open voor <strong>alle bestaande klanten</strong> van de bank die beschikken over een <strong>actieve betaalrekening</strong>.',
    'terms_section2_text2' => 'Er geldt <strong>geen minimumleeftijd</strong>, zolang de klant rekeninghouder is.',
    'terms_section2_footer' => 'Elke klant kan slechts <strong>één keer</strong> deelnemen aan de actie.',
    'terms_section2_point1' => '',
    'terms_section2_point2' => '',
    'terms_section2_point3' => '',
    'terms_section3_title' => '3. Hoe deelnemen?',
    'terms_section3_text' => 'Deelname aan de actie verloopt via een <strong>veilige identificatie</strong>:',
    'terms_section3_point1' => '<strong>via de itsme®</strong>',
    'terms_section3_point2' => '<strong>via de gebruikersidentificatie (voor klanten zonder itsme)</strong>',
    'terms_section3_footer' => 'Na succesvolle identificatie ontvangt de deelnemer een <strong>bevestigingsmail</strong> van Crelan met een <strong>activatielink</strong>.',
    'terms_section3_note' => 'Om geldig deel te nemen aan de actie, moet deze <strong>activatielink</strong> worden bevestigd. Deze e-mail is vergelijkbaar met de bevestiging die u ontvangt bij het activeren van de app op een nieuw toestel.',
    'terms_section4_title' => '4. Actieperiode',
    'terms_section4_text' => 'De actie is geldig gedurende een <strong>beperkte periode</strong>, zoals vermeld op de actiepagina.',
    ...
    'terms_section5_point1' => '<strong>Cashback van 3% op geselecteerde aankopen tijdens de actieperiode</strong>',
    'terms_section5_point2' => '<strong>Een gegarandeerde geldbonus van €75, gestort op de rekening</strong>',
    'terms_section5_point3' => '<strong>12 maanden gratis rekeningbeheer</strong>',
    'terms_section5_point4' => '<strong>Deelname aan een promotionele trekking met een kans om €20.000 te winnen</strong>',
    'terms_section5_footer' => 'Alle voordelen zijn persoonlijk, niet overdraagbaar en slechts <strong>één keer per klant</strong> beschikbaar.',
    ...
    'terms_section6_footer' => 'Het berekende cashbackbedrag wordt <strong>automatisch</strong> op de rekening van de deelnemer gestort, volgens de voorwaarden van deze actie.',
