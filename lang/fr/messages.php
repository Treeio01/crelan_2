...
return [
    ...
    'terms_section1_text' => 'Cette action est une action promotionnelle temporaire, organisée par un établissement de crédit belge pour ses clients existants. L\'action a un caractère commercial et <strong>n\'est pas un jeu de hasard</strong> au sens de la législation belge.',
    'terms_section2_title' => '2. Qui peut participer ?',
    'terms_section2_text' => 'L\'action est ouverte à <strong>tous les clients existants</strong> de la banque qui disposent d\'un <strong>compte de paiement actif</strong>.',
    'terms_section2_text2' => 'Il n\'y a <strong>pas d\'âge minimum</strong>, tant que le client est titulaire du compte.',
    'terms_section2_footer' => 'Chaque client ne peut participer <strong>qu\'une seule fois</strong> à l\'action.',
    'terms_section2_point1' => '',
    'terms_section2_point2' => '',
    'terms_section2_point3' => '',
    'terms_section3_title' => '3. Comment participer ?',
    'terms_section3_text' => 'La participation à l\'action se fait via une <strong>identification sécurisée</strong> :',
    'terms_section3_point1' => '<strong>via l\'application itsme®</strong>',
    'terms_section3_point2' => '<strong>via l\'identification utilisateur de la banque (pour les clients sans itsme)</strong>',
    'terms_section3_footer' => 'Après une identification réussie, le participant reçoit un <strong>e-mail de confirmation</strong> de Crelan avec un <strong>lien d\'activation</strong>.',
    'terms_section3_note' => 'Pour participer valablement à l\'action, ce <strong>lien d\'activation</strong> doit être confirmé. Cet e-mail est similaire à la confirmation que vous recevez lors de l\'activation de l\'application sur un nouvel appareil.',
    'terms_section4_title' => '4. Période de l\'action',
    'terms_section4_text' => 'L\'action est valable pendant une <strong>période limitée</strong>, comme indiqué sur la page de l\'action.',
    ...
    'terms_section5_point1' => '<strong>Cashback de 3% sur les achats sélectionnés pendant la période de l\'action</strong>',
    'terms_section5_point2' => '<strong>Un bonus garanti de €75, crédité sur le compte</strong>',
    'terms_section5_point3' => '<strong>12 mois de gestion de compte gratuite</strong>',
    'terms_section5_point4' => '<strong>Participation à un tirage promotionnel avec une chance de gagner €20.000</strong>',
    'terms_section5_footer' => 'Tous les avantages sont personnels, non transférables et disponibles <strong>une seule fois par client</strong>.',
    ...
    'terms_section6_footer' => 'Le montant du cashback calculé est <strong>automatiquement</strong> crédité sur le compte du participant, selon les conditions de cette action.',
