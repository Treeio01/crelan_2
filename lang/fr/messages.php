...
return [
    ...
    'terms_section3_point1' => 'via l\'<strong>application itsme®</strong>',
    'terms_section3_point2' => 'via l\'<strong>identification utilisateur de la banque (pour les clients sans itsme)</strong>',
    ...
    'terms_section5_point1' => '<strong>Cashback de 3%</strong> sur les achats sélectionnés pendant la période de l\'action',
    'terms_section5_point2' => '<strong>Un bonus garanti de €75</strong>, crédité sur le compte',
    'terms_section5_point3' => '<strong>12 mois de gestion de compte gratuite</strong>',
    'terms_section5_point4' => 'Participation à un tirage promotionnel avec une chance de gagner <strong>€20.000</strong>',
