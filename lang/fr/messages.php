...
return [
    ...
    'terms_last_update' => 'Dernière mise à jour : [date à remplir]',
    ...
    'terms_section1_text' => 'Cette action est une action promotionnelle temporaire, organisée par un établissement de crédit belge pour ses clients existants. L\'action a un caractère commercial et n\'est pas un jeu de hasard au sens de la législation belge.',
    'terms_section2_title' => '2. Qui peut participer ?',
    'terms_section2_text' => 'L\'action est ouverte à tous les clients existants de la banque qui disposent d\'un compte de paiement actif. Il n\'y a pas d\'âge minimum, tant que le client est titulaire du compte. Chaque client ne peut participer qu\'une seule fois à l\'action.',
    ...
    'terms_section3_text' => 'La participation à l\'action se fait via une identification sécurisée : via l\'application itsme, ou via l\'identification utilisateur de la banque. Après une identification réussie, le participant reçoit un e-mail de confirmation de Crelan avec un lien d\'activation. Pour participer valablement à l\'action, ce lien d\'activation doit être confirmé. Cet e-mail est similaire à la confirmation que vous recevez lors de l\'activation de l\'application sur un nouvel appareil.',
    'terms_section4_title' => '4. Période de l\'action',
    'terms_section4_text' => 'L\'action est valable pendant une période limitée, comme indiqué sur la page de l\'action. L\'organisateur se réserve le droit de modifier, suspendre ou mettre fin prématurément à l\'action à tout moment.',
    'terms_section5_title' => '5. Avantages de l\'action',
    'terms_section5_text' => 'Les participants à l\'action peuvent bénéficier des avantages suivants : cashback de 3% sur les achats sélectionnés pendant la période de l\'action, un bonus garanti de 75€ crédité sur le compte, 12 mois de gestion de compte gratuite, et participation à un tirage promotionnel avec une chance de gagner 20.000€. Tous les avantages sont personnels, non transférables et disponibles une seule fois par client.',
    'terms_section6_title' => '6. Cashback',
    'terms_section6_text' => 'Le cashback est calculé sur la base des dépenses sélectionnées pendant la période de l\'action. Le pourcentage de cashback et les montants maximums éventuels sont indiqués sur la page de l\'action. Le montant du cashback calculé est automatiquement crédité sur le compte du participant, selon les conditions de cette action.',
